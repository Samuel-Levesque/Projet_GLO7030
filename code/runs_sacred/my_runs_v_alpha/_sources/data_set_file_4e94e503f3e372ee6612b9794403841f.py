...
def create_huge_data_set(path,nb_rows,size_image,skip_rows=None,filenames=None):
    '''
...
if __name__ == "__main__":
    ...
    essai=DoodlesDataset(csv_file, path,nrows=select_nrows, size=size_image,skiprows=10)
