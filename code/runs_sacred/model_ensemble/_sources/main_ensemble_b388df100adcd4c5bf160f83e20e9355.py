...
from model_creation import create_model,create_ensemble_model
...
def main_program(path_data,path_save_model,path_load_existing_model,path_model_weights_test,
    ...
    if do_testing:
        ...
        acc, loss, score_top3, conf_mat, acc_per_class = calcul_metric_concours(model_final, valid_loader,
                                                                                use_gpu=use_gpu,
